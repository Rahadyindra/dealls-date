...
function swipeExecuteProcessor(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const swipe = yield SwipeInService_1.default.findByUserIdAndProfileIdToday(userId, profile === null || profile === void 0 ? void 0 : profile.id);
            if (swipe) {
                throw { name: "invalid.input" };
            }
...
function validateQuota(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (swipes > 9 && !((_b = user.userPremiumPackage) === null || _b === void 0 ? void 0 : _b.premiumPackage.noSwipeQuota)) {
                throw { name: "no.quota" };
            }
        }
        catch (err) {
